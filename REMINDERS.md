...
- Актуальні: `2026-08-24/` (01–04) · `2026-08-25/` (**05**) · `2026-08-29/` (**06** довідники · **07** профіль/налаштування · **08** системні · **09** вет/профі)
- Коли юзер шле скрін у чат — **одразу** копіювати в цю папку з читабельною назвою.
- `.tmp-screens/` = QA app capture, **не** макет.
- **Screenshot-first (GLOBAL, LOCKED):** для **всієї аплікації** — **скрін = істина.** Старий код **не має ваги**; перебудова під скрін, не «підправити старий». Якщо суперечить — пишемо **як на скріні**, не об’єднуємо/hybrid. Правило в `.cursor/rules/pixel-screens.mdc` + `.cursorrules`.
...
- **2026-08-24 LOCKED header:** `app-hd` = логотип + **аватар** + лапка (`#0F6D38`, unread>0) + terracotta **цифра** (unread>1). **Тап аватар → Мій профіль** (не Activity). Дзвіночок / Activity — у профілі (04.25). Лапка зникає після перегляду Активності.
