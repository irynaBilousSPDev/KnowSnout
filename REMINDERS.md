...
| **запустити** | `20260321235000_pet_life_stage.sql` | `pets.life_stage` для матчу корму |
...
| Ідея | Статус |
|--|--|
| Корм ↔ алергії / life stage match | ✅ UI + `foodMatch` · SQL `life_stage` |
...
Останнє оновлення: 2026-07-27 — профіль: місто + список улюбленців у Мої дані.
