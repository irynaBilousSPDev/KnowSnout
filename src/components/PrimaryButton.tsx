...
const styles = StyleSheet.create({
  ...
  sizeMd: { minHeight: 48, paddingHorizontal: 18, paddingVertical: 12 },
  sizeLg: { minHeight: 50, paddingHorizontal: 20, paddingVertical: 14 },
  sizeSm: { minHeight: 38, paddingHorizontal: 14, paddingVertical: 8 },
